...
const AddToFireFox = ({ className = '', isMobile = false }) => {
  return (
    <li
    ...
    >
      <a 
        href="https://addons.mozilla.org/en-US/firefox/addon/product-review-insight/?utm_source=addons.mozilla.org&utm_medium=referral&utm_content=search"
